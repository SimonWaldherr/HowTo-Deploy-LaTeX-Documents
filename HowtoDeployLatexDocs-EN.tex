...
\item
  in line 20 and 22 is the call of the \texttt{pdflatex} program for converting
  .tex to .pdf
\item
  in line 25 and 26, the PDF gets converted to a
  \href{https://en.wikipedia.org/wiki/DjVu}{DjVu document}
\item
  in line 29 you can see how to transfer the generated data via wget
\item
  the at line 34 defined provider \textbf{releases} stands for
  \textbf{GitHub releases}
\item
  in line 38 the required \textbf{oauth} string for
  ...
  \item
    ...
    encrypted part in row 38
  \end{itemize}
\item
  in lines 42 to 46 the files to upload are defined
\end{itemize}
